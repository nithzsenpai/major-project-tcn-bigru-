...
- Writable RSSI-delta arrays under Pandas Copy-on-Write behavior on Windows
- Zenodo downloader retry configuration for HTTP 429 and temporary 5xx failures
